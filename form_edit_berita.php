	...
	<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    	<header class="mdl-layout__header" style="background-color:#0680F9">
        	<div class="mdl-layout__header-row">
            	<span class="mdl-layout-title">Shaka - Edit Berita</span>
        ...
        <div class="mdl-layout__drawer">
          <span class="mdl-layout-title">Edit Berita</span>
            ...
            <form method="post" action="edit_berita.php" enctype="multipart/form-data">
              <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
               ...
               <label name="id" class="mdl-textfield__label" for="user" style="margin-left:30px">ID Berita</label>
              </div><br/>
         			 <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
          			 <input name="judul" class="mdl-textfield__input" type="text" value="<?= $result['judul'];?>" style="margin-left:30px" required>
               <label name="judul" class="mdl-textfield__label" for="user" style="margin-left:30px">Judul Berita</label>
              </div><br/>
              <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                <textarea name="informasi" class="mdl-textfield__input" type="text" style="margin-left:30px" required><?=$result['informasi'];?></textarea>
              ...
              <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                <input name="tanggal" class="mdl-textfield__input" type="date" value="<?= $result['tanggal'];?>" style="margin-left:30px" required>
                <label name="tanggal" class="mdl-textfield__label" for="text" style="margin-left:30px"></label>
              </div><br />
              <center><img style="width: 200px; height:200px;" src="Images/<?php echo $result['img'];?> "></center><br>

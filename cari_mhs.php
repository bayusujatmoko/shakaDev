	...
	<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    	<header class="mdl-layout__header" style="background-color:#0680F9">
        	<div class="mdl-layout__header-row">
            	<span class="mdl-layout-title">Hasil Pencarian Mahasiswa</span>
                <div class="mdl-layout-spacer"></div>
            </div>
        </header>
        <div class="mdl-layout__drawer">
            <span class="mdl-layout-title">Data Mahasiswa</span>
            <nav class="mdl-navigation">
                <a class="mdl-navigation__link" href="tampil_mhs.php"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation" style="margin-right:20px">arrow_back</i>Back to MHS</a>
            </nav>
        </div>
                	...
                	<div class="mdl-grid">
                        ...
                        <th width="10%">AKSI</th>
                            ...
                            <?php
                                include 'connect.php';
                                $nama = $_POST['nama']; 
                                $query = mysql_query("SELECT * from mahasiswa where nama like '%$nama%'");
                            ...
                            <tr>
                                ...
                                <td>
                                    <a id="btn-submit" href="edit_mhs.php?nim=<?php echo $record['nim']; ?>">Edit</a><br><br>
                                    <a id="btn-submit" href="delete_mhs.php?nim=<?php echo $record['nim']; ?> " onclick="return klikHapus();">Hapus</a>
                                </td>
                            </tr>
                                <?php } ?>
                            </table>

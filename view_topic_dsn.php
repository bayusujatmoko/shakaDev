	...
	<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
        ...
        <div class="mdl-layout__drawer" style="height:wrap;">
            ...
            <nav class="mdl-navigation">
                ...
                <a class="mdl-navigation__link" href="main_forum_dsn.php"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation" style="margin-right:20px">arrow_back</i>Back to Topic</a>
            </nav>
        </div>
          ...
          <footer style="background: #212a38">
              ...
              <div style="padding: 5px;">
                  <?php
                        ...
                        $q=mysql_query("SELECT * FROM dosen WHERE username='$username'");
                    ...
                    <table style="width: 800px" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
                        ...
                        <tr>
                        <form name="form1" method="post" action="add_answer_dsn.php">
                        <td>

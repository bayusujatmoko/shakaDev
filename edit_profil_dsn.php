<?php
	...
	if(!$p){
		...
		$q =mysql_query("UPDATE dosen SET img = '$img', nama ='$nama', jurusan='$jurusan', email='$email',fakultas='$fakultas' WHERE nidn='$nidn'");
		if($q){
			echo "<script>alert('Data Berhasil Diubah !'); window.location = 'tampil_profil_dsn.php'</script>";
		}else{

<?php
  ...
  $query1=mysql_query("SELECT * FROM mahasiswa WHERE username='$username'");
?>
	...
	<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    	<header class="mdl-layout__header" style="background-color:#0680F9">
        	<div class="mdl-layout__header-row">
            	<span class="mdl-layout-title">Shaka - Profil Mahasiswa</span>
        ...
        <div class="mdl-layout__drawer">
        	<span class="mdl-layout-title">Profil Mahasiswa</span>
            	...
            	<div class="page-content" style="min-height: 75vh">
                	<div class="mdl-grid">
                        ...
                        <div style="margin-left:60px; padding-top:10px">
			                     <h1 class="font" align="center">Profil Mahasiswa</h1>
                            ...
                            <tbody>
                              <?php
                                ...
                                { ?>
                                  ...
                                  <tr>
                                    <td style="border: 0px">NIM</td>
                                    <td style="border: 0px">:</td>
                                    <td style="border: 0px"><?=$result1['nim']?></td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    <td style="border: 0px;"><input type="button" value="Edit Profil" id="btn-submit" onclick="window.location = 'form_edit_profil_mhs.php?nim=<?php echo $result1['nim'];?>';"/></td>
                                  </tr>

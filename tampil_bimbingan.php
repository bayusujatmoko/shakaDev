<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
 <?php
    ...
    $query = mysql_query("SELECT * FROM bimbingan WHERE nidn = (SELECT nidn FROM dosen WHERE username='$username')");
 ?>
	...
	<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    	<header class="mdl-layout__header" style="background-color:#0680F9">
        	<div class="mdl-layout__header-row">
            	<span class="mdl-layout-title">Tampil Mahasiswa Bimbingan | <?php echo $_SESSION['dosen']; ?></span>
                <div class="mdl-layout-spacer"></div>
                <form action="cari_bimbingan.php" method="post">
                    <label>Cari Mahasiswa Bimbingan : </label>
                    <input style="width: 300px" type="text" name="nama" placeholder="Masukkan Nama Mahasiswa Bimbingan">

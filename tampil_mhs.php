	...
	<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    	<header class="mdl-layout__header" style="background-color:#0680F9">
        	<div class="mdl-layout__header-row">
            	<span class="mdl-layout-title">Tampil Data Mahasiswa</span>
                <div class="mdl-layout-spacer"></div>
                <form action="cari_mhs.php" method="post">
                    <label>Cari Mahasiswa : </label>
                    <input style="width: 300px" type="text" name="nama" placeholder="Masukkan Nama Mahasiswa">

...
<title>Ubah Pass Mahasiswa</title>
	...
	<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    	<header class="mdl-layout__header" style="background-color:#0680F9">
        	<div class="mdl-layout__header-row">
            	<span class="mdl-layout-title">Shaka - Ubah Password Mahasiswa</span>
        ...
        <div class="mdl-layout__drawer">
          <span class="mdl-layout-title">Ubah Password</span>
            ...
            <form method="post" action="ubah_pass_mhs.php">
              <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                 <input name="nim" class="mdl-textfield__input" type="hidden" value="<?= $result['nim'];?>" style="margin-left:30px" readonly>
              </div><br/>
         			 <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">

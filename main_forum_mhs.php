	...
	<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    	<header class="mdl-layout__header" style="background-color:#0680F9">
        	<div class="mdl-layout__header-row">
            	<span class="mdl-layout-title">Forum Diskusi berdasarkan Topik</span>
                <div class="mdl-layout-spacer"></div>
                <form action="cari_forum_mhs.php" method="post">
                    <label>Cari Forum : </label>
                    <input style="width: 300px" type="text" name="topic" placeholder="Masukkan Topik Diskusi">
        	...
        	<main class="mdl-layout__content" style="height:wrap">
            	<div class="page-content" style="min-height: 75vh">
                	<div class="mdl-grid">
                        ...
                        <td align="center">
                        <a class="mdl-navigation__link" href="view_topic_mhs.php?id=<?php echo $rows['id']; ?>" >
                        <div id="btn-submit">
                        <?= $rows['topic']; ?>
                        </div>
                        </a>

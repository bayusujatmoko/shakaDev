                       	...
                       	<div class="mdl-cell mdl-cell--4-col">
                        	<div class="demo-updates mdl-card mdl-shadow--6dp mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet mdl-cell--12-col-desktop">
                             <?php
                              ...
                              ?>
                              <form action="update_bimbingan.php" method="POST">
                                <br>
                               ...
                               <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                ...
                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                  <input name= "nidn" value="<?=$record['nidn'];?>" class="mdl-textfield__input" type="text" id="user" style="margin-left:30px">
                                <label class="mdl-textfield__label" for="user" style="margin-left:30px">NIDN</label>
                                </div><br/>
                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                  <input name= "dosen" value="<?=$record['dosen'];?>" class="mdl-textfield__input" type="text" id="user" style="margin-left:30px">
                                <label class="mdl-textfield__label" for="user" style="margin-left:30px">Nama Dosen</label>
                                </div><br/>
                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                ...
                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                <input name= "telepon" value="<?=$record['telepon'];?>" class="mdl-textfield__input" type="text" id="pass" style="margin-left:30px">
                                <label class="mdl-textfield__label" for="text" style="margin-left:30px">No Telepon</label>
                                </div><br />
                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                <input name= "judul" value="<?=$record['judul'];?>" class="mdl-textfield__input" type="text" id="pass" style="margin-left:30px">

...
<body bgcolor="#D4DFFF">
	<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    	<header class="mdl-layout__header" style="background-color:#0680F9">
        	<div class="mdl-layout__header-row">
            	<span class="mdl-layout-title">Anda Login Sebagai Dosen, Selamat Datang <?php echo $_SESSION['dosen']; ?></span>
        ...
        <div class="mdl-layout__drawer">
        	<span class="mdl-layout-title"><?php echo $_SESSION['dosen']; ?></span>
            <nav class="mdl-navigation">
              <a class="mdl-navigation__link" href="tampil_profil_dsn.php"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation" style="margin-right:20px">person</i>Lihat Profil</a>
                <a class="mdl-navigation__link" href="form_ubah_pass_dsn.php"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation" style="margin-right:20px">settings</i>Ubah Password</a>
                ...
                <a class="mdl-navigation__link" href="logout_dsn.php"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation" style="margin-right:20px">arrow_back</i>Logout</a>
            </nav>
            <span class="mdl-layout-title">Bimbingan MHS</span>
            <nav class="mdl-navigation">
                <a class="mdl-navigation__link" href="tampil_bimbingan.php"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation" style="margin-right:20px">person</i>Tampil Bimbingan</a>
            </nav>
        </div>
                    	...
                    	<div class="mdl-cell mdl-cell--8-col"><div class="demo-updates mdl-card mdl-shadow--6dp mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet mdl-cell--12-col-desktop">
                          ...
                          <?php
                           ...
                           <table width="500" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
                            <tr>
                            <form id="form1" name="form1" method="post" action="create_topic_dsn.php">
                            <td>
  ...
  <div class="mdl-card__supporting-text" align="justify">
   	Fitur - fitur Sharing Knowledge Application (Dosen)
  </div>
  <div class="mdl-card__supporting-text" align="justify">
     <ol>
        <li>Dosen dapat membuat topik diskusi baru dan memberikan tanggapan/jawaban
        dari topik diskusi yang sudah ada</li>
        <li>Dosen dapat melihat siapa saja Mahasiswa yang ingin melakukan bimbingan terhadapnya</li>
        <li>Dosen mengkonfirmasi Mahasiswa yang ingin melakukan bimbingan terhadapnya dengan
        memberi tanggapan di menu Tampil Bimbingan -> edit</li>
        <li>Dosen dapat melakukan edit profil dan mengubah password</li>
     </ol>

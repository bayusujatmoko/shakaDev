<?php
  ...
  $nidn = $_GET['nidn'];
  $query = mysql_query("SELECT * FROM dosen WHERE nidn = '$nidn'");
	...
	<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    	<header class="mdl-layout__header" style="background-color:#0680F9">
        	<div class="mdl-layout__header-row">
            	<span class="mdl-layout-title">Shaka - Edit Profil Dosen</span>
        ...
        <div class="mdl-layout__drawer">
          <span class="mdl-layout-title">Edit Dosen</span>
            ...
            <form method="post" action="edit_profil_dsn.php" enctype="multipart/form-data">
              <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                 <input name="nidn" class="mdl-textfield__input" type="number" value="<?= $result['nidn'];?>" style="margin-left:30px" readonly>
               <label name="nidn" class="mdl-textfield__label" for="user" style="margin-left:30px">NIDN</label>
              </div><br/>
         			 <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
